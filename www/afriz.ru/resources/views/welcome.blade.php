...
<html lang="ru">
  <head>
    ...
    <meta
      name="description"
      content="Провайдер ПолитехТелеком предоставляет быстрый и надежный интернет"
    />
    <meta
      name="keywords"
      content="ПолитехТелеком, провайдер связи, интернет, быстрый интернет, мобильная связь, работа, IT"
    />
    <meta name="author" content="AFriz Corp" />
    <meta name="robots" content="index, follow" />
    <meta
      name="title"
      content="ПолитехТелеком - Ваш провайдер связи и интернета"
    />
        ...
        <nav>
          <ul class="nav">
            <li>
              ...
              <a href="tel:+78000000000" class="phone-link"
                >+7 (800) 000-00-00</a
              >
            </li>
            <li>
    ...
    <div class="user-panel">
      <div class="div">
        ...
        <div class="main-container">
          ...
          <div class="user-fio">Картошкин Антон Станиславович</div>
          <div class="text-balance">Баланс</div>
          <div class="user-balance">839,14 ₽</div>
          <div class="frame-userid">
            <div class="overlap-group">
              <div class="circle"></div>
              <div class="user-code">837234</div>
            </div>
          </div>
        </div>
        <div class="user-packets">
          ...
          <p class="packet-info">
            Пакет “Профи” (GPON 900 Мбит) + Мобайл “Минимум”
          </p>
          <div class="packet-prive">910 руб\мес</div>
        </div>
        <div class="frame">
